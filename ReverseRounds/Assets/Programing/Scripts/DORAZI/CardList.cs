...
public class CardList
{
    ...
    public System.Action<PlayerMove> ApplyEffect;

    public CardList(string name, string description, System.Action<PlayerMove> effect)
    {
        Name = name;
    ...
    public void Use(PlayerMove player)
    {
